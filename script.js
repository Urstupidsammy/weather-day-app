$(document).ready(function() {
    ...
    //OpenWeather API 
    const apiKey = '31beee9b35dec58c199884ec44456028'

    //Selectors so the HTML elements will display the weather
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                for(let i = 0; i <= 5; i++) {
                    ...
                    $(`div.day-$[i] .fiveDay-humidity`).text(currDay.humidity);
                }
            });
        });
    }
    ...
    $(document).on("click", "button.city-btn", function (event) {
        ...
        let foundCity = $(this).grep(pastCities, function (storedCity){
